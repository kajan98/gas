...
class IndustrialHomeTabScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const IndustrialHomeTabScreen({
    Key? key, 
    required this.userData,
  }) : super(key: key);

  @override
  State<IndustrialHomeTabScreen> createState() => _IndustrialHomeTabScreenState();
}

class _IndustrialHomeTabScreenState extends State<IndustrialHomeTabScreen> {
