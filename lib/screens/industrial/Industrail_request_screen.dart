...
class IndustrialRequestScreen extends StatelessWidget {
  final Map<String, dynamic> selectedOutlet;
  final Map<String, dynamic> userData;

  const IndustrialRequestScreen({
    Key? key, 
  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(
      builder: (context, cartProvider, child) {
        // Ensure industrial mode is set
        cartProvider.isIndustrial = true;
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: quantity > 1
                                                ? () => cartProvider.updateQuantity1(index, false)
                                                : null,
                                          ...
                                          IconButton(
                                          onPressed: () => cartProvider.updateQuantity1(index, true),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            print('User Name: ${userData['company_name']}');
                            ...
                            try {
                              final response = await http.post(
                                      Uri.parse('${ApiConstants.baseUrl1}/api/submit_industrial_request.php'),
